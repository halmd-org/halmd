            ...
            [
                ...
                [
                    class_<truncate, shared_ptr<truncate> >("truncate")
                        ...
                        .def("on_write", &truncate::on_write<multi_array<float, 4> >, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<float, 4>&>, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<float, 4> const&>, pure_out_value(_2))
                        ...
                        .def("on_write", &truncate::on_write<multi_array<double, 4> >, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<double, 4>&>, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<double, 4> const&>, pure_out_value(_2))
                        ...
                        .def("on_write", &truncate::on_write<multi_array<uint64_t, 4> >, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<uint64_t, 4>&>, pure_out_value(_2))
                        .def("on_write", &truncate::on_write<multi_array<uint64_t, 4> const&>, pure_out_value(_2))
