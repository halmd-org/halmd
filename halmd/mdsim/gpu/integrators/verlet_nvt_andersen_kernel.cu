...
template class verlet_nvt_andersen_wrapper<3, float, random::gpu::mrg32k3a_rng>;
template class verlet_nvt_andersen_wrapper<2, float, random::gpu::mrg32k3a_rng>;
...
template class verlet_nvt_andersen_wrapper<3, dsfloat, random::gpu::mrg32k3a_rng>;
template class verlet_nvt_andersen_wrapper<2, dsfloat, random::gpu::mrg32k3a_rng>;
