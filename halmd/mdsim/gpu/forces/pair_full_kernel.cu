...
// template class pair_full_wrapper<3, lennard_jones_kernel::lennard_jones>;
// template class pair_full_wrapper<2, lennard_jones_kernel::lennard_jones>;

template class pair_full_wrapper<3, lennard_jones_simple_kernel::lennard_jones_simple>;
template class pair_full_wrapper<2, lennard_jones_simple_kernel::lennard_jones_simple>;

template class pair_full_wrapper<3, morse_kernel::morse>;
template class pair_full_wrapper<2, morse_kernel::morse>;
