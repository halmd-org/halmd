...
#ifndef HALMD_MDSIM_GPU_POTENTIALS_EXTERNAL_SLIT_HPP
#define HALMD_MDSIM_GPU_POTENTIALS_EXTERNAL_SLIT_HPP
...
{
public:
    typedef slit_kernel::slit<dimension> gpu_potential_type;
...
#endif /* ! HALMD_MDSIM_GPU_POTENTIALS_EXTERNAL_SLIT_HPP */
