...
template class pair_full<3, float, potentials::lennard_jones_simple<float> >;
template class pair_full<2, float, potentials::lennard_jones_simple<float> >;
template class pair_trunc<3, float, potentials::lennard_jones_simple<float> >;
template class pair_trunc<2, float, potentials::lennard_jones_simple<float> >;
template class pair_trunc<3, float, potentials::lennard_jones_simple<float>, mdsim::forces::trunc::local_r4<float> >;
template class pair_trunc<2, float, potentials::lennard_jones_simple<float>, mdsim::forces::trunc::local_r4<float> >;
