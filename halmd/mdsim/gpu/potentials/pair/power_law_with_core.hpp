...
#ifndef HALMD_MDSIM_GPU_POTENTIALS_PAIR_POWER_LAW_WITH_CORE_HPP
#define HALMD_MDSIM_GPU_POTENTIALS_PAIR_POWER_LAW_WITH_CORE_HPP
...
public:
    ...
    {
        return power_law_with_core_kernel::compute(rr, sigma_(a,b)*sigma_(a,b), epsilon_(a,b)
                                                 , r_core_sigma_(a,b), index_(a,b));
    }
...
#endif /* ! HALMD_MDSIM_GPU_POTENTIALS_PAIR_POWER_LAW_WITH_CORE_HPP */
