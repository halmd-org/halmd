...
#ifndef HALMD_MDSIM_GPU_POTENTIALS_PAIR_HARD_CORE_HPP
#define HALMD_MDSIM_GPU_POTENTIALS_PAIR_HARD_CORE_HPP
...
#endif /* ! HALMD_MDSIM_GPU_POTENTIALS_PAIR_HARD_CORE_HPP */
