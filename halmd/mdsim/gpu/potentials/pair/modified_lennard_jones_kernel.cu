...
template class discontinuous_wrapper<modified_lennard_jones_kernel::modified_lennard_jones>;
...
template class pair_trunc_wrapper<3, discontinuous<modified_lennard_jones> >;
template class pair_trunc_wrapper<2, discontinuous<modified_lennard_jones> >;
