...
HALMD_LUA_API int luaopen_libhalmd_mdsim_host_forces_pair_trunc(lua_State* L)
{
    ...
    pair_trunc<3, float_type, modified_lennard_jones<float_type>, local_r4<float_type> >::luaopen(L);
    pair_trunc<2, float_type, modified_lennard_jones<float_type>, local_r4<float_type> >::luaopen(L);

    pair_trunc<3, float_type, morse<float_type> >::luaopen(L);
    pair_trunc<2, float_type, morse<float_type> >::luaopen(L);
    pair_trunc<3, float_type, morse<float_type>, local_r4<float_type> >::luaopen(L);
    pair_trunc<2, float_type, morse<float_type>, local_r4<float_type> >::luaopen(L);

    pair_trunc<3, float_type, power_law<float_type> >::luaopen(L);
    pair_trunc<2, float_type, power_law<float_type> >::luaopen(L);
    pair_trunc<3, float_type, power_law<float_type>, local_r4<float_type> >::luaopen(L);
    pair_trunc<2, float_type, power_law<float_type>, local_r4<float_type> >::luaopen(L);
    ...
    pair_trunc<3, float_type, power_law_with_core<float_type>, local_r4<float_type> >::luaopen(L);
    pair_trunc<2, float_type, power_law_with_core<float_type>, local_r4<float_type> >::luaopen(L);
    return 0;
}
...
template class pair_trunc<3, float_type, modified_lennard_jones<float_type>, local_r4<float_type> >;
template class pair_trunc<2, float_type, modified_lennard_jones<float_type>, local_r4<float_type> >;

template class pair_trunc<3, float_type, morse<float_type> >;
template class pair_trunc<2, float_type, morse<float_type> >;
template class pair_trunc<3, float_type, morse<float_type>, local_r4<float_type> >;
template class pair_trunc<2, float_type, morse<float_type>, local_r4<float_type> >;

template class pair_trunc<3, float_type, power_law<float_type> >;
template class pair_trunc<2, float_type, power_law<float_type> >;
template class pair_trunc<3, float_type, power_law<float_type>, local_r4<float_type> >;
template class pair_trunc<2, float_type, power_law<float_type>, local_r4<float_type> >;
...
template class pair_trunc<3, float_type, power_law_with_core<float_type>, local_r4<float_type> >;
template class pair_trunc<2, float_type, power_law_with_core<float_type>, local_r4<float_type> >;
