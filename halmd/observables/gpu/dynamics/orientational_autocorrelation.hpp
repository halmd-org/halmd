...
#ifndef HALMD_OBSERVABLES_GPU_DYNAMICS_ORIENTATIONAL_AUTOCORRELATION_HPP
#define HALMD_OBSERVABLES_GPU_DYNAMICS_ORIENTATIONAL_AUTOCORRELATION_HPP
...
public:
    ...
    static char const* module_name() { return "orientational_autocorrelation"; }

    static void luaopen(lua_State* L);

    orientational_autocorrelation(
...
#endif /* ! HALMD_OBSERVABLES_GPU_DYNAMICS_ORIENTATIONAL_AUTOCORRELATION_HPP */
