...
#ifndef HALMD_OBSERVABLES_GPU_DYNAMICS_MEAN_SQUARE_DISPLACEMENT_KERNEL_HPP
#define HALMD_OBSERVABLES_GPU_DYNAMICS_MEAN_SQUARE_DISPLACEMENT_KERNEL_HPP
...
struct mean_square_displacement_wrapper
{
    ...
    static mean_square_displacement_wrapper const wrapper;
};
...
#endif /* ! HALMD_OBSERVABLES_GPU_DYNAMICS_MEAN_SQUARE_DISPLACEMENT_KERNEL_HPP */
