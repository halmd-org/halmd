...
template class reduction_kernel<tagged_particle<mean_square_displacement<3, float>, dsfloat> >;
template class reduction_kernel<tagged_particle<mean_square_displacement<2, float>, dsfloat> >;
