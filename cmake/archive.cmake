...
set(HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG
  "CMakeFiles/libs-boost-log.tar"
)
set(HALMD_ARCHIVE_INTERMEDIATE_LIBS_H5XX
  "CMakeFiles/libs-h5xx.tar"
)
set(HALMD_ARCHIVE_INTERMEDIATE_LUABIND
  "CMakeFiles/libs-luabind.tar"
)
set(HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG_H5XX
  "CMakeFiles/libs-boost-log+h5xx.tar"
)
...
add_custom_command(OUTPUT ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG}
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/libs/boost-log
  COMMAND git archive
    --format=tar
    --output=${CMAKE_CURRENT_BINARY_DIR}/${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG}
    --prefix=${HALMD_ARCHIVE_PREFIX}/libs/boost-log/
    HEAD
  DEPENDS ${CMAKE_BINARY_DIR}/cmake/version.cmake
)

add_custom_command(OUTPUT ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_H5XX}
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/libs/h5xx
  COMMAND git archive
    --format=tar
    --output=${CMAKE_CURRENT_BINARY_DIR}/${HALMD_ARCHIVE_INTERMEDIATE_LIBS_H5XX}
...
add_custom_command(OUTPUT ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG_H5XX}
  COMMAND cmake -E rename
    ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG}
    ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG_H5XX}
  COMMAND tar
    --concatenate
    --file=${HALMD_ARCHIVE_INTERMEDIATE_LIBS_BOOST_LOG_H5XX}
    ${HALMD_ARCHIVE_INTERMEDIATE_LIBS_H5XX}
