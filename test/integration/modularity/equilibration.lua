...
--
-- Setup and equilibrate mixture using a unique instance of the particle module
--
function main(args)
    local dimension = args.dimension    -- dimension of space
    local density = args.density        -- number density
    local temp = args.temperature
    ...
    local integrator = mdsim.integrators.verlet_nvt_boltzmann({
      ...
      , timestep = args.timestep, temperature = temp0, rate = args.rate
    })
    ...
    integrator:set_temperature(temp)
