...
BOOST_FIXTURE_TEST_CASE( verlet_nvt_andersen_gpu_float_2d, set_cuda_device ) {
    verlet_nvt_andersen<gpu_modules<2, float> >().test();
}
BOOST_FIXTURE_TEST_CASE( verlet_nvt_andersen_gpu_float_3d, set_cuda_device ) {
    verlet_nvt_andersen<gpu_modules<3, float> >().test();
}
# endif
# ifdef USE_GPU_DOUBLE_SINGLE_PRECISION
BOOST_FIXTURE_TEST_CASE( verlet_nvt_andersen_gpu_dsfloat_2d, set_cuda_device ) {
    verlet_nvt_andersen<gpu_modules<2, dsfloat> >().test();
}
BOOST_FIXTURE_TEST_CASE( verlet_nvt_andersen_gpu_dsfloat_3d, set_cuda_device ) {
