...
BOOST_AUTO_TEST_CASE( modified_lennard_jones_host )
{
    ...
    typedef mdsim::host::potentials::pair::modified_lennard_jones<float_type> potential_type;
...
#else
    typedef mdsim::host::potentials::pair::modified_lennard_jones<float> host_potential_type;
#endif
