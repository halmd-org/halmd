...
struct function_by_const_ref_fixture : lua_test_fixture
{
    ...
    static std::function<int const& (int, int, int, int, int, int, int, int, int)> wrap_slot_by_const_ref9()
    {
    ...
    static int call_slot_by_const_ref9(std::function<int const& (int, int, int, int, int, int, int, int, int)> const& slot_by_const_ref, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9)
    {
