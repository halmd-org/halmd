...
template <typename position_sample_type, typename writer_type>
...
template <typename position_sample_type, typename reader_type>
...
void h5md(std::vector<unsigned int> const& ntypes)
{
    ...
    // construct phase space sample and fill with positions
    ...
    on_write_sample(float_position_sample, writer);
    ...
    on_write_sample(double_position_sample, writer);
    ...
    on_read_sample(double_position_sample_, reader);
    ...
    on_read_sample(float_position_sample_, reader);
