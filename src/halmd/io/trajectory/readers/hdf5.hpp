...
public:
    ...
    typedef typename sample_type::position_sample_pointer position_sample_pointer;
    typedef typename sample_type::velocity_sample_pointer velocity_sample_pointer;
