...
#ifndef HALMD_MATH_VECTOR4D_HPP
#define HALMD_MATH_VECTOR4D_HPP
 ...
 */
template <typename T>
inline vector<T, 4> cos(vector<T, 4> v)
{
    v[0] = std::cos(v[0]);
    v[1] = std::cos(v[1]);
    v[2] = std::cos(v[2]);
 ...
 */
template <typename T>
inline vector<T, 4> sin(vector<T, 4> v)
{
    v[0] = std::sin(v[0]);
    v[1] = std::sin(v[1]);
    v[2] = std::sin(v[2]);
