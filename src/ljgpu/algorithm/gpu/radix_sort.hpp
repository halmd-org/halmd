...
#ifndef LJGPU_ALGORITHM_GPU_RADIX_SORT_HPP
#define LJGPU_ALGORITHM_GPU_RADIX_SORT_HPP

#include <cuda_wrapper.hpp>

namespace ljgpu { namespace gpu { namespace radix_sort
{
...
#endif /* ! LJGPU_ALGORITHM_GPU_RADIX_SORT_HPP */
