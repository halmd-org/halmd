 ...
 */
template <typename float_type, int dimension>
void energy<float_type, dimension>::open(std::string const& filename)
{
 ...
 */
template <typename float_type, int dimension>
H5param energy<float_type, dimension>::attrs()
{
...
template <typename float_type, int dimension>
template <typename trajectory_sample>
void energy<float_type, dimension>::sample(trajectory_sample const& sample, float_type const& density, float_type const& time)
{
 ...
 */
template <typename float_type, int dimension>
void energy<float_type, dimension>::flush(bool force)
{
    if (!m_samples_buffer)
	// empty buffers
	return;
 ...
 */
template <typename float_type, int dimension>
void energy<float_type, dimension>::close()
{
