...
template <>
vector<float, 2> rint(vector<float, 2> v)
{
    v[0] = rintf(v[0]);
    v[1] = rintf(v[1]);
    return v;
...
template <>
vector<double, 2> rint(vector<double, 2> v)
{
    v[0] = rint(v[0]);
    v[1] = rint(v[1]);
    return v;
...
template <>
vector<float, 2> round(vector<float, 2> v)
{
    v[0] = roundf(v[0]);
    v[1] = roundf(v[1]);
    return v;
...
template <>
vector<double, 2> round(vector<double, 2> v)
{
    v[0] = round(v[0]);
    v[1] = round(v[1]);
    return v;
