...
void options::parse(int argc, char** argv)
{
	...
	("pair-separation,p", po::value<double>()->default_value(0.5), "pair separation at which particle collision occurs")
	("density,d", po::value<double>()->default_value(0.1), "particle density")
	("box-length,L", po::value<double>(), "simulation box length")
	("timestep,r", po::value<double>()->default_value(0.01), "sample timestep")
	...
	("steps,s", po::value<uint64_t>()->default_value(10000), "number of sample steps")
#ifndef USE_BENCHMARK
	("time,t", po::value<double>(), "total sample time")
#endif
